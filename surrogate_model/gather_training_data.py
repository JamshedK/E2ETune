...
WORKLOADS = [
    {'data_dir': 'ycsb_data', 'metrics_subdir': 'ycsb', 'workload_prefix': './oltp_workloads/ycsb/'},
    {'data_dir': 'tpcc_data', 'metrics_subdir': 'tpcc', 'workload_prefix': './oltp_workloads/tpcc/'},
    {'data_dir': 'smallbank', 'metrics_subdir': 'smallbank', 'workload_prefix': './oltp_workloads/smallbank/'},
    {'data_dir': 'twitter', 'metrics_subdir': 'twitter', 'workload_prefix': './oltp_workloads/twitter/'},
    {'data_dir': 'wikipedia', 'metrics_subdir': 'wikipedia', 'workload_prefix': './oltp_workloads/wikipedia/'}
]
