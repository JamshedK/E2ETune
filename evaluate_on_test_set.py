...
def generate_response(model, tokenizer, instruction, input_data):
...
def evaluate_model(model_path, test_data, knobs_detail):
    ...
    for i, item in enumerate(test_data):
        ...
        pred_response = generate_response(model, tokenizer, instruction, input_data)
...
def main():
    # Load test data
    test_file = "LLaMA-Factory/data/db_tuning_test.json"
